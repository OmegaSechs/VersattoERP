...
static async criar({ nome, cpf_cnpj, email, telefone, is_cliente, is_fornecedor, is_pessoa_fisica, criado_em, atualizado_em, nome_fantasia, is_pessoa_juridica, rua, bairro, numero, celular, cidade, estado, cep }) {
    const query = `
        INSERT INTO pessoas (nome, cpf_cnpj, email, telefone, is_cliente, is_fornecedor, is_pessoa_fisica, criado_em, atualizado_em, nome_fantasia, is_pessoa_juridica, rua, bairro, numero, celular, cidade, estado, cep)
